...
public class Fetch5thlawsuit extends screesnhot {
	
	public void cllickon5strecentlawsuit(ChromeDriver driver) throws InterruptedException {

		try {
			driver.findElementByXPath("//li[@class='hs-postlisting-item'][5]/a").click();
		} catch (Exception e) {
			JavascriptExecutor executor = (JavascriptExecutor) driver;
			executor.executeScript("arguments[0].click();", driver.findElementByXPath("//li[@class='hs-postlisting-item'][5]/a"));
		}}
		...
		if(title.contains(Finaltitle)){
			...
			this.getscreenshot(driver, "test5.png") ; 
		...
		public void get5stplaintiffinfo(ChromeDriver driver){
		...
		public void get5stdefendantinfo(ChromeDriver driver){
