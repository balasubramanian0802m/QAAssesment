...
public class Fetch4thlawsuit extends screesnhot{
	
	public void cllickon4strecentlawsuit(ChromeDriver driver) throws InterruptedException {

		try {
			driver.findElementByXPath("//li[@class='hs-postlisting-item'][4]/a").click();
		} catch (Exception e) {
			JavascriptExecutor executor = (JavascriptExecutor) driver;
			executor.executeScript("arguments[0].click();", driver.findElementByXPath("//li[@class='hs-postlisting-item'][4]/a"));
		}}
	...
	public void assertcheck(ChromeDriver driver) throws IOException{
		...
		if(title.contains(Finaltitle)){
			...
			this.getscreenshot(driver, "test4.png") ; 
		...
		public void get4stplaintiffinfo(ChromeDriver driver){
		...
		public void get4stdefendantinfo(ChromeDriver driver){
