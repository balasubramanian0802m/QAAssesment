...
public class Fetch3rdlawsuit extends screesnhot {
	
	public void cllickon3strecentlawsuit(ChromeDriver driver) throws InterruptedException {

		try {
			driver.findElementByXPath("//li[@class='hs-postlisting-item'][3]/a").click();
		} catch (Exception e) {
			JavascriptExecutor executor = (JavascriptExecutor) driver;
			executor.executeScript("arguments[0].click();", driver.findElementByXPath("//li[@class='hs-postlisting-item'][3]/a"));
		}}
	...
	public void assertcheck(ChromeDriver driver) throws IOException{
		...
		if(title.contains(Finaltitle)){
			...
			this.getscreenshot(driver, "test3.png") ; 
		...
		public void get3stplaintiffinfo(ChromeDriver driver){
		...
		public void get3stdefendantinfo(ChromeDriver driver){
